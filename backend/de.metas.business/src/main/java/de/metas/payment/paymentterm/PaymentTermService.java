...
public class PaymentTermService
{
			...
			@NonNull final Percent discount)
	{
		...
		final PaymentTerm basePaymentTermRecord = paymentTermRepository.getById(basePaymentTermId);
		...
		final I_C_PaymentTerm existingDerivedPaymentTermRecord = Services.get(IQueryBL.class)
				...
				.addEqualsFilter(I_C_PaymentTerm.COLUMNNAME_AD_Client_ID, basePaymentTermRecord.getClientId().getRepoId())
				.addEqualsFilter(I_C_PaymentTerm.COLUMNNAME_AD_Org_ID, basePaymentTermRecord.getOrgId().getRepoId())
